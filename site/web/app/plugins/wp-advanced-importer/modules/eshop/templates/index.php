...
?>
	...
	<form action='<?php echo admin_url().'admin.php?page='.WP_CONST_ADVANCED_XML_IMP_SLUG.'/index.php&__module='.$_REQUEST['__module'].'&step=mapping_settings'?>' id='browsefile' method='post' name='browsefile' enctype="multipart/form-data">
...
?>
	...
	<!-- The global progress bar -->
          <div class="form-group" style="padding-bottom:20px;">
                                ...
                                <input type='button' name='clearform' id='clearform' value='<?php echo __("Clear",'wp-advanced-importer'); ?>' onclick="Reload();" class='btn btn-warning' style="margin-right:15px"/>
                          
                               <input type='submit' name='importfile' id='importfile' title = '<?php echo __("Next",'wp-advanced-importer'); ?>' value='<?php echo $impCE->reduceStringLength(__("Next",'wp-advanced-importer'),'Next'); echo __(" >>");?>' disabled  class='btn btn-primary' style="margin-right:15px"/>
                                </div>
                                </tr>
                                </table>
...
?>
 ...
 <div id='importrightaway' style='display:block'>
		...
		<label id="innertitle"><?php echo __('Inline image options','wp-advanced-importer'); ?></label><br />
                <label id='importalign'> <input type ='checkbox' id='multiimage' name='multiimage' value = ''><?php echo __('Insert Inline Images','wp-advanced-importer'); ?> </label><?php echo $impCE->inlinehelpnotes(); ?><br>
                <input type='hidden' id='inlineimagevalue' name='inlineimagevalue' value='none' />
		</li>
		</ul>
		<input id="startbutton" class="btn btn-primary" type="button" value="<?php echo __('Import Now','wp-advanced-importer'); ?>" onclick="importRecordsbySettings('<?php echo site_url(); ?>');" >
